...
@pytest.fixture
def message_error_for_filter_by_state():
    """Сообщение об ошибке для функции filter_by_state"""
...
@pytest.fixture
def result_transaction_descriptions():
    return [
        "Перевод организации",
...
@pytest.fixture
def transaction_test_value_200():
    return {
...
def info_to_test_read_files():
    df = [
        ...
        {'id': '3598919', 'state': 'CANCELED', 'date': '2020-12-06T23:00:58Z',
